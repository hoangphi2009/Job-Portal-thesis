...
import { registerCV, updatePersonalDetailsCV, updateProfeExpCV, updateEducationCV, updateSkillCV, deleteCV, getAllCVs, getCVById, getAllCVsForAdmin } from "../controllers/cv.controller.js";
...
router.get('/admin/cvs', isAuthenticated, getAllCVsForAdmin);
